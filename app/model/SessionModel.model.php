...
class SessionModel extends DBController
{
    ...
    // the function below returns $united_order_items for other functions 
    ...
    {   
        ...
        if (empty($result_get_united_order)) {
                throw new Exception("Function get_united_order_items wasn't successful");
                                             } else {
