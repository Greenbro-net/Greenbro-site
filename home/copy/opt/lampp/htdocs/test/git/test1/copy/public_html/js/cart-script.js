   ...
   function showDescription() {
      ...
      $.ajax({
         ...
         success: function(data){
            ...
            $(".description_block").append("<div class ='descr_price'><p>Цена </p>" + "$"+price + "</div>");
         }
      });
   }
         ...
         for(let i = 0; i < cart.length; i++) {
            if(cart[i] !== undefined) {
               ...
               let string = "<div class=\"checkout-item\" data-for='"+ productId + "'>" +
                   ...
                   "<div class=\"quantity-input\" style=\"margin-top: 25px;\">" +
                   "<input class=\"minus btn\" type=\"button\" value=\"-\">" +
                   "<input class=\"input-text quantity text\" style=\"text-align: center;\" value=\"1\" size=\"4\" data-quantity=\"" + productQuantity + "\">" +
"<input class=\"plus btn\" type=\"button\" value=\"+\">" +
"</div>"+
                   // "<p class=\"checkout-quantity\">Количество: " + productQuantity + "</p>" +
