<!-- the code below can pass variable in href -->
	...
	<?php 
		...
		$view_val_obj  = new App\Controller\ViewValidationController();
	...
	?>
	 ...
	 <div class="user_loggedin_menu" id="user_loggedin_menu">
		...
		<!-- the block of code -->
		<input type="hidden" value="<?php  echo App\Controller\ValidationController::display_user_data(); ?>"  id="deletion_button">
