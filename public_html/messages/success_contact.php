...
<head>
    ...
    <!--require css for success messages-->
    <!--<link rel="stylesheet" type="text/css" href="/other_css/registration_css.css">-->
...
<?php
require_once "/home/green64/public_html/scripts/header.php";

// There are we connenct array with messages
require_once 'array_messages.php';
?>


<!--There are will be success message-->
<!-- If user sent a massage show this message for him -->
<div id="success_messages">
    <div class="success">
       <p id="success_words"><?php echo $_MESSAGES['success_contact']; ?></p>
    </div>
</div>


<!--The element for right view of this page-->
<div id="the_biggest_one"></div>

<!--This code makes redirect after five seconds-->
 <meta http-equiv="refresh" content="5;url=//greenbro.net">


<?php
require_once "/home/green64/public_html/scripts/footer.php";
?>
