...
<head>
    <meta charset="utf-8">
    <title>Greenbro Публічна оферта</title>
...
<p>Наведений нижче текст є договором між інтернет-магазином, сайт якого розміщений в мережі Інтернет за адресою https://greenbro.net , що має назву надалі «Інтернет-магазин», і користувачем послуг Інтернет-магазину, що має назву надалі «Покупець», і визначає умови купівлі-продажу товарів Покупцем через сайт інтернет-магазину.
</p>
 

<h4>1. Загальні положення</h4>

<p>1.1. Цей договір є договором публічної оферти (відповідно до ст. Ст. 633, 641 і гл. 63 Цивільного кодексу України), його умови однакові для всіх покупців незалежно від статусу (фізична особа, юридична особа, фізична особа - підприємець).
</p>
<p>
...
<p>
2.1. Торгова марка - «Greenbro», заснована відповідно до Законодавства України, та оперує сайтом, розміщеним в мережі Інтернет за адресою https://greenbro.net 
</p>
<p>
...
<p>
2.5. Сайт - сукупність сторінок, доступ до яких здійснюється за допомогою веб-браузера, і програмних модулів, об'єднаних єдиною системою управління, розташованих в мережі Інтернет за адресою https://greenbro.net , і містить всі ознаки публічної оферти з пошуку, комплектації і резервування Товарів обраних Покупцем на сайті.
</p>
<p>
...
<h4>4. Правила роботи з Сайтом</h4>
...
<p>
4.3. При реєстрації Покупець вводить такі дані:</p>
...
<p>
4.6. Покупець зобов'язується не повідомляти третім особам параметри доступу, зазначені при реєстрації. У разі виникнення у Покупця підозр щодо несанкціонованого використання третіми особами таких параметрів, Покупець зобов'язується негайно повідомити про це Інтернет-магазину, надіславши електронний лист на адресу  greenbro.net@gmail.com або зв'язатися по телефону: (093) 770-72-71.
</p>
...
<h4>5. Порядок оформлення Замовлення</h4>
...
<h4>7. Умови повернення.</h4>

<p>
7.3. Повернення товарів і обмін товарів кінцевим споживачам, здійснюється в порядку, передбаченому чинним законодавством України.
</p>
 

<h4>8. Конфіденційність і захист персональних даних</h4>
...
<h4>9. Інформаційні повідомлення</h4>
...
<h4>10. Правила використання матеріалів, розміщених на Сайті</h4>
...
<p>11.1. Цей договір укладено на території України і підпорядковується матеріальному праву України.
</p>
