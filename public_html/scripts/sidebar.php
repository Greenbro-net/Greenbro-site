	<ul id="menu">
	    ...
	    <li><a href="//greenbro.net/scripts/books.php">Література</a></li>
	    <li><a href="//greenbro.net/scripts/allthings.php">Все разом</a></li>
	    <li><a href="//greenbro.net/scripts/payment_and_delivery.php">Оплата і доставка</a></li>
